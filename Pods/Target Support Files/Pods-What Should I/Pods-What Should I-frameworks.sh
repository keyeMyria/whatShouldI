...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Localide/Localide.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MarqueeLabel/MarqueeLabel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MaterialColor/MaterialColor.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NotificationBannerSwift/NotificationBannerSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ReachabilityLib/ReachabilityLib.framework"
