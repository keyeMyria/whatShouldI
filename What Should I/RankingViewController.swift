...
class PlaceRankingViewController: UIViewController, CLLocationManagerDelegate {
    ...
    let numObj: Int = 4 // # total objects being compared; arbitrarily set at 4
    ...
    func loadRanks() {
        ...
        // logic to prevent repeats and to give alert if less than 2
        itemsToRank = Array(shuffledSearchResults.prefix(4)) // use first 4 elements
